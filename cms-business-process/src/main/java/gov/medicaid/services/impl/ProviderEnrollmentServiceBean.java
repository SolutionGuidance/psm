...
public class ProviderEnrollmentServiceBean extends BaseService implements ProviderEnrollmentService {
     ...
     *            the profile id
     * @param fetchChildren
     *            true if the full object is needed
     ...
     * @throws PortalServiceException
     *             if the user does not own or cannot access the entity
     */
    @SuppressWarnings("rawtypes")
     ...
     * 
     * @param ticketId
     *            the ticket to insert the details for
     * @param details
     *            the details to insert
     * @throws PortalServiceException
     *             for any errors encountered
     */
     ...
     * 
     * @param profileId
     *            the profile id (0 if pending enrollment)
     * @param ticketId
     *            the ticket id (0 if not a provider)
     * @param entity
     ...
     *            the user performing the operation.
     * @param ticketId
     *            the ticket that will be cleared
     * @throws PortalServiceException
     *             for any errors encountered
     */
     ...
     * 
     * @param ticketId
     *            the ticket to search for
     * @param fetchChildren
     *            if true, the entire object tree is retrieved
     ...
     * 
     * @param profileId
     *            the profile id of the provider
     * @param ticketId
     *            the request ticket id
     ...
     */
    private String saveAttachmentContent(InputStream content) throws IOException {
        String contentId = UUID.randomUUID().toString();
        BinaryContent binaryContent = new BinaryContent();
        binaryContent.setContentId(contentId);
        binaryContent.setContent(Hibernate.createBlob(content));
     ...
     * 
     * @param criteria
     *            the criteria used for search
     * @param maxColumns
     *            the maximum number allowed as sort column
     */
     ...
     * 
     * @param profileId
     *            the profile associated to the note
     * @param ticketId
     *            the ticket associated
     */
     ...
     * 
     * @param user
     *            the user creating the note
     * @param profileId
     *            the profile to attach it to
     * @param ticketId
     *            the ticket to attach it to
     * @param text
     *            the note text
     */
     ...
     *            the ticket to be saved
     * @param insertDetails
     *            if true, also reinserts the details
