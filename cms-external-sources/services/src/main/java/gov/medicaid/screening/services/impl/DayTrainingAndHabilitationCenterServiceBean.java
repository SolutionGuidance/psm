...
/**
 * This class provides an EJB implementation of the DayTrainingAndHabilitationCenterService interface. It
...
@WebService
@Stateless
@Remote(DayTrainingAndHabilitationCenterService.class)
@TransactionManagement(TransactionManagementType.CONTAINER)
public class DayTrainingAndHabilitationCenterServiceBean extends BaseService implements DayTrainingAndHabilitationCenterService {
    /**
     * Represent the name of this class
     */
    private static final String CLASS_NAME = DayTrainingAndHabilitationCenterServiceBean.class.getName();
     ...
     * Empty constructor
     */
    public DayTrainingAndHabilitationCenterServiceBean() {
    }
    ...
    protected void init() {
        super.init();
        if (dayTrainingAndHabilitationCenterDAO == null) {
            throw new ConfigurationException("The dayTrainingAndHabilitationCenterDAO must be configured.");
        }
    }
    ...
    public SearchResult<ProviderProfile> search(DayTrainingAndHabilitationCenterSearchCriteria criteria) throws ServiceException {
