...
/**
 * This class provides an EJB implementation of the HospitalLicensingService interface. It
...
@WebService
@Stateless
@Remote(HospitalLicensingService.class)
@TransactionManagement(TransactionManagementType.CONTAINER)
public class HospitalLicensingServiceBean extends BaseService implements HospitalLicensingService {
    /**
     * Represent the name of this class
     */
    private static final String CLASS_NAME = HospitalLicensingServiceBean.class.getName();
     ...
     * Empty constructor
     */
    public HospitalLicensingServiceBean() {
    }
    ...
    protected void init() {
        super.init();
        if (hospitalLicensingDAO == null) {
            throw new ConfigurationException("The hospitalLicensingDAO must be configured.");
        }
    }
