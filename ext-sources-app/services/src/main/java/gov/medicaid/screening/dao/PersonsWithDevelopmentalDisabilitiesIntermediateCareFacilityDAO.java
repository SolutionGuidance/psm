...
/**
 * This represents the persistence API to search for persons with developmental disabilities intermediate care facility for the given search
 * criteria.
 * 
 ...
 */
public interface PersonsWithDevelopmentalDisabilitiesIntermediateCareFacilityDAO {
    /**
