...
/**
 * This represents the persistence API to search for private duty nursing groups for the given search criteria.
 * 
 * @author argolite, TCSASSEMBLER
 * @version 1.0
 * @since Organizational Provider Screening External Datasources Services 1
 */
public interface PrivateDutyNursingGroupLicensingDAO {
    /**
     ...
     */
    public SearchResult<ProviderProfile> search(PrivateDutyNursingGroupSearchCriteria criteria) throws ParsingException,
            ServiceException;
}
