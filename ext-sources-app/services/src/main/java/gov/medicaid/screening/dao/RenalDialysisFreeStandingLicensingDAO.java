...
/**
 * This represents the persistence API to search for renal dialysis free standings for the given search criteria.
 * 
 * @author argolite, TCSASSEMBLER
 * @version 1.0
 * @since Organizational Provider Screening External Datasources Services 1
 */
public interface RenalDialysisFreeStandingLicensingDAO {
    /**
     ...
     */
    public SearchResult<ProviderProfile> search(RenalDialysisFreeStandingSearchCriteria criteria) throws ParsingException,
            ServiceException;
}
