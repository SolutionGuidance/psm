...
/**
 * This class provides an EJB implementation of the ChemicalDependencyProgramDAO interface. It is a stateless,
 * local bean.
 * 
 * <p>
 ...
 */
@Stateless
@Local(ChemicalDependencyProgramDAO.class)
@TransactionManagement(TransactionManagementType.CONTAINER)
public class ChemicalDependencyProgramDAOBean extends LicensedProviderCommonDAO implements
        ChemicalDependencyProgramDAO {
    /**
     * Represent the name of this class
     */
    private static final String CLASS_NAME = ChemicalDependencyProgramDAOBean.class.getName();

    /**
     * Represent the license type id.
     */
    private static final String licenseTypeId = "38";

    /**
     * Default empty constructor.
     */
    public ChemicalDependencyProgramDAOBean() {
    }
