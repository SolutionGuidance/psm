...
/**
 * This represents the service API to search for community mental health centers for the given search criteria.
 * <p>
 ...
 */
public interface CommunityMentalHealthCenterLicensingService {
    /**
