...
/**
 * This class provides an EJB implementation of the PharmacyLicensingService interface. It
 ...
 */
@Stateless
@Remote(PharmacyLicensingService.class)
@TransactionManagement(TransactionManagementType.CONTAINER)
public class PharmacyLicensingServiceBean extends BaseService implements PharmacyLicensingService {
    /**
     * Represent the name of this class
     */
    private static final String CLASS_NAME = PharmacyLicensingServiceBean.class.getName();
     ...
     * Empty constructor
     */
    public PharmacyLicensingServiceBean() {
    }
    ...
    protected void init() {
        super.init();
        if (pharmacyLicensingDAO == null) {
            throw new ConfigurationException("The pharmacyLicensingDAO must be configured.");
        }
    }
