...
public class StartupServlet extends HttpServlet {
    ...
    public void init() {
        try {
            ...
            dmfScheduler = (SchedulerService) context.lookup("cms-external-sources/DeathMasterSchedulerBean/local");
            pecosScheduler = (SchedulerService) context.lookup("cms-external-sources/PECOSSchedulerBean/local");
