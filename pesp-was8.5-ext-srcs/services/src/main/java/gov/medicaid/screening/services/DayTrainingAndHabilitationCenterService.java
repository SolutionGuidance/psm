...
/**
 * This represents the service API to search for day training and habilitation center for the given search criteria.
 * <p>
 ...
 */
public interface DayTrainingAndHabilitationCenterService {
    /**
