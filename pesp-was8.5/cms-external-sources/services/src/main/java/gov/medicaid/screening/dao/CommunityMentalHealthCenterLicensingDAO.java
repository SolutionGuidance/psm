...
/**
 * This represents the persistence API to search for community mental health centers for the given search criteria.
 * 
 * @author argolite, TCSASSEMBLER
 * @version 1.0
 * @since Organizational Provider Screening External Datasources Services 1
 */
public interface CommunityMentalHealthCenterLicensingDAO {
    /**
     ...
     */
    public SearchResult<ProviderProfile> search(CommunityMentalHealthCenterSearchCriteria criteria) throws ParsingException,
            ServiceException;
}
