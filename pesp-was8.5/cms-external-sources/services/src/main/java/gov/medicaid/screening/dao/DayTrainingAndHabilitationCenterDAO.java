...
/**
 * This represents the persistence API to search for day training and habilitation center for the given search
 * criteria.
 * 
 ...
 */
public interface DayTrainingAndHabilitationCenterDAO {
    /**
