...
/**
 * This class provides an EJB implementation of the PersonsWithDevelopmentalDisabilitiesIntermediateCareFacilityService interface. It
...
@WebService
@Stateless
@Remote(PersonsWithDevelopmentalDisabilitiesIntermediateCareFacilityService.class)
@TransactionManagement(TransactionManagementType.CONTAINER)
public class PersonsWithDevelopmentalDisabilitiesIntermediateCareFacilityServiceBean extends BaseService implements PersonsWithDevelopmentalDisabilitiesIntermediateCareFacilityService {
    /**
     * Represent the name of this class
     */
    private static final String CLASS_NAME = PersonsWithDevelopmentalDisabilitiesIntermediateCareFacilityServiceBean.class.getName();
     ...
     * Empty constructor
     */
    public PersonsWithDevelopmentalDisabilitiesIntermediateCareFacilityServiceBean() {
    }
    ...
    protected void init() {
        super.init();
        if (personsWithDevelopmentalDisabilitiesIntermediateCareFacilityDAO == null) {
            throw new ConfigurationException("The personsWithDevelopmentalDisabilitiesIntermediateCareFacilityDAO must be configured.");
        }
    }
    ...
    public SearchResult<ProviderProfile> search(PersonsWithDevelopmentalDisabilitiesIntermediateCareFacilitySearchCriteria criteria) throws ServiceException {
        ...
        try {
            SearchResult<ProviderProfile> results = personsWithDevelopmentalDisabilitiesIntermediateCareFacilityDAO.search(criteria);
