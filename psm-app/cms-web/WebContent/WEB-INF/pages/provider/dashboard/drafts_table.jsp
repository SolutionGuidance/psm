...
<table cellpadding="0" cellspacing="0" class="generalTable" id="draftTable">
    ...
    <thead>
        ...
        <tr class="tablesorter-header">
            <th class="alignCenter"><div class="tablesorter-header-inner"><input type="checkbox" class="selectAll" title="select all" name="providerIds"><span class="sep"></span></div></th>
        ...
        <c:forEach var="item" items="${results.items}" varStatus="status">
            ...
            <tr class="${status.index % 2 == 0 ? 'even' : 'odd'}">
                <td class="alignCenter">
                    <input type="checkbox" title="select item" name="providerIds" value="${item.ticketId}"/>
                </td>
