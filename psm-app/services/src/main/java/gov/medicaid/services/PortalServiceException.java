...
public class PortalServiceException extends BaseCriticalException {
     ...
     */
    public PortalServiceException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     * @param data additional data regarding the exception
     */
    public PortalServiceException(String message, Throwable cause, ExceptionData data) {
