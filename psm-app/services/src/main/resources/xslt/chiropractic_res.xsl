    ...
    <xsl:template match="/">
                <ns2:LicenseVerificationResponse xmlns:ns2="http://gov.medicaid.services.enrollment/ValidationService" xmlns="http://gov.medicaid.shared/Entities" xmlns:ns3="http://gov.medicaid.process/EnrollmentProcess">
                    <ns2:Output>
                        ...
                        <SearchResults>
                            <xsl:for-each select="//ext:searchByLastNameResponse/return/items">
                            <SearchResultItem>
                                <ColumnData>
                                    <NameValuePair>
                                    ...
                                    <NameValuePair>
                                        <Name>Phone</Name>
                                        <Value><xsl:value-of select="profile/contactPhoneNumber/text()"></xsl:value-of></Value>
                                    </NameValuePair>
                                    <NameValuePair>
                                        <Name>Address</Name>
                                        <Value><xsl:value-of select="profile/addresses/location/text()"></xsl:value-of></Value>
                                    </NameValuePair>
                                    <NameValuePair>
                                        <Name>City</Name>
                                        <Value><xsl:value-of select="profile/addresses/city/text()"></xsl:value-of></Value>
                                    </NameValuePair>
                                    <NameValuePair>
                                        <Name>State</Name>
                                        <Value><xsl:value-of select="profile/addresses/state/text()"></xsl:value-of></Value>
                                    </NameValuePair>
                                    <NameValuePair>
