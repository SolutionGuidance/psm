    ...
    <xsl:template match="/">
                <ns2:LicenseVerificationResponse xmlns:ns2="http://gov.medicaid.services.enrollment/ValidationService" xmlns="http://gov.medicaid.shared/Entities" xmlns:ns3="http://gov.medicaid.process/EnrollmentProcess">
                    <ns2:Output>
                        ...
                        <SearchResults>
                            <xsl:for-each select="//ext:searchResponse/return">
                            <SearchResultItem>
                                <ColumnData>
                                    <NameValuePair>
                                    ...
                                    <NameValuePair>
                                        ...
                                        <Value><xsl:value-of select="licenses/licenseNumber/text()"></xsl:value-of></Value>
                                    </NameValuePair>
                                    <NameValuePair>
                                        <Name>Issue Date</Name>
                                        <Value><xsl:value-of select="licenses/originalIssueDate/text()"></xsl:value-of></Value>
                                    </NameValuePair>
                                    <NameValuePair>
                                        <Name>City</Name>
