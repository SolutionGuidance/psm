		   ...
		   <soapenv:Body>
		      <impl:search>
		         <arg0>
		             ...
		             <value><xsl:value-of select="//ext:LicenseVerificationRequest/ext:ProviderInformation/ext2:ApplicantInformation/ext2:OrganizationInformation/ext2:Name/text()"></xsl:value-of></value>
		         </arg0>
		      </impl:search>
		   </soapenv:Body>
		</soapenv:Envelope>
