...
class PSMRequirements:
    """Class for obtaining PSMRequirements instances from CSV input.
    The only element that matters is .reqs, a dict mapping requirement
    IDs to PSMRequirement instances. Maybe we'll have other fields some day."""
